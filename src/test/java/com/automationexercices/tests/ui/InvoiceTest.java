...
@Feature("UI Download Invoice Management")
@Story("Download Invoice Management")
...
public class InvoiceTest extends BaseTest {
    ...
    @Description("TC06 - Verify that user can download invoice successfully")
    public void downloadInvoice() {
        new PaymentPage(driver)
                .clickDownloadInvoiceButton()
                .verifyInvoiceIsDownloadedSuccessfully(testData.getJsonData("invoiceName"));
    }
    @Description("TC07 - Verify that user can delete account successfully")
    @Test(dependsOnMethods = {"loginExistingAccount", "regesterNewAccount", "addToCartProducts", "proceedToCheckout", "paymentAndOrderConfirmation"})
